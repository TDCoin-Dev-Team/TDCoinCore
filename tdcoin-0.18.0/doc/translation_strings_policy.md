...
This document provides guidelines for internationalization of the Tdcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tdcoin_en.ts` remains unchanged.
