Tdcoin Core version 0.9.2.1 is now available from:

  https://tdcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TDC to 0.01 TDC
...
- Fix "Start tdcoin on system login"
