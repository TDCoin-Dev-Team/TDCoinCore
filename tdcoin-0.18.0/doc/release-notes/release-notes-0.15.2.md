Tdcoin Core version *0.15.2* is now available from:

  <https://tdcoincore.org/bin/tdcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in tdcoin-tx (TheBlueMatt)
