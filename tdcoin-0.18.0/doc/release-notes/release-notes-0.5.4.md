Tdcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tdcoin/files/Tdcoin/tdcoin-0.5.4/
...
http://gitorious.org/tdcoin/tdcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Tdcoin-Qt notifications under Growl 1.3.
Increase required age of Tdcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTdcoin properly when installing Tdcoin-Qt over it. (Windows)
