Tdcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tdcoin/files/Tdcoin/tdcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Tdcoin
...
New/changed settings (command-line or tdcoin.conf file)
--------------------------------------------------------
