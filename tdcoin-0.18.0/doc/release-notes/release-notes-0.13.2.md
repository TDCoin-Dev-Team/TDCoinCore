Tdcoin Core version 0.13.2 is now available from:

  <https://tdcoin.org/bin/tdcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update tdcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tdcoin-tx to create v2 transactions (TDCdrak)
