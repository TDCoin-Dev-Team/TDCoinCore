Tdcoin Core version 0.9.4 is now available from:

  https://tdcoin.org/bin/0.9.4/
...
this update is incompatible with the Tdcoin system and could lead to consensus
forks.

Tdcoin Core released binaries from https://tdcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tdcoin/+archive/ubuntu/tdcoin
- A third-party or self-compiled Tdcoin Core

upgrade to Tdcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
