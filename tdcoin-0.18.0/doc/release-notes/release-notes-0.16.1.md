Tdcoin Core version 0.16.1 is now available from:

  <https://tdcoincore.org/bin/tdcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting tdcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure tdcoind processes are cleaned up when tests end (sdaftuar)
