Tdcoin Core version 0.10.4 is now available from:

  <https://tdcoin.org/bin/tdcoin-core-0.10.4/>
...
- #6953 `43c2789` Split tdcoin-tx into its own package
- #6953 `dfe0d4d` Include tdcoin-tx binary on Debian/Ubuntu
