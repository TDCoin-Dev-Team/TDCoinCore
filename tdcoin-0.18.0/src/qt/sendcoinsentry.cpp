    ...
    platformStyle(_platformStyle)
{
    ...
    // normal tdcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying tdcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TdcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
