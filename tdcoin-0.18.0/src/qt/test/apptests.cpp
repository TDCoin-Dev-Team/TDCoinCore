...
//! Entry point for TdcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TdcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TdcoinGUI tests.
void AppTests::guiTests(TdcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TdcoinGUI::consoleShown, this, &AppTests::consoleTests);
