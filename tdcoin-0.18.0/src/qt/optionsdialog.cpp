    ...
    mapper(nullptr)
{
    ...
    ui->tdcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tdcoinAtStartup);
    ...
    ui->tdcoinAtStartup->setToolTip(ui->tdcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->tdcoinAtStartup->setText(ui->tdcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTdcoinConfButton->setToolTip(ui->openTdcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TdcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tdcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTdcoinConfButton_clicked()
{
