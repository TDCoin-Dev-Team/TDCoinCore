...
#ifndef TDCOIN_QT_TDCOINUNITS_H
#define TDCOIN_QT_TDCOINUNITS_H
...
/** Tdcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TdcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TdcoinUnits(QObject *parent);

    /** Tdcoin units.
      @note Source: https://en.tdcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TDC,
...
typedef TdcoinUnits::Unit TdcoinUnit;

#endif // TDCOIN_QT_TDCOINUNITS_H
