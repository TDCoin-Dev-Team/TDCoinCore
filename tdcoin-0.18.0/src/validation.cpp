...
#if defined(NDEBUG)
# error "Tdcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Tdcoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	TIP = ( nHeight == TIP001 ? 500000000 : 100000000 );
    }else{
	TIP = 150;
    }
    CAmount nSubsidy = TIP * COIN;
