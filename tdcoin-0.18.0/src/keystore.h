...
#ifndef TDCOIN_KEYSTORE_H
#define TDCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/tdcoin/bips/blob/master/bip-0013.mediawiki
