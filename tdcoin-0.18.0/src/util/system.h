 ...
 */
#ifndef TDCOIN_UTIL_SYSTEM_H
#define TDCOIN_UTIL_SYSTEM_H
...
extern const char * const TDCOIN_CONF_FILENAME;
...
{
    std::string s = strprintf("tdcoin-%s", name);
