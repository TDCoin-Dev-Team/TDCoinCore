...
#ifndef TDCOIN_WALLET_WALLET_H
#define TDCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! tdcoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this tdcoin node, and set to 0 for transactions that were created
