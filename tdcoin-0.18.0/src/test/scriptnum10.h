...
#ifndef TDCOIN_TEST_SCRIPTNUM10_H
#define TDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tdcoin Core 0.10.0, for cross-comparison.
 */
public:
