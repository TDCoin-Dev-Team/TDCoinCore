...
#ifndef TDCOIN_TXMEMPOOL_H
#define TDCOIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/tdcoin/tdcoin/pull/14193 will fix it. No known code
     * in tdcoin currently depends on second guarantee, but it is important to
