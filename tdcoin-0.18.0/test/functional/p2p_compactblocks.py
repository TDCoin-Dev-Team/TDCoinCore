...
# TestP2PConn: A peer we use to send messages to tdcoind, and store responses.
...
class CompactBlocksTest(TdcoinTestFramework):
    ...
    # This test actually causes tdcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that tdcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for tdcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # tdcoind will not send blocktxn responses for blocks whose height is
