#!/usr/bin/env python3
# Copyright (c) 2015-2019 The Tdcoin Core developers
...
class FullBlockTest(TdcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure tdcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure tdcoind isn't accepting b28
        ...
        # tdcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the tdcoin code has custom code which does so);
