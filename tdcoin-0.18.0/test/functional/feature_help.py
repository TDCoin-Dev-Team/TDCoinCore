...
"""Verify that starting tdcoin with -h works as expected."""

from test_framework.test_framework import TdcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TdcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tdcoin with -h for help text")
        ...
        self.log.info("Start tdcoin with -version for version information")
        ...
        self.log.info("Start tdcoind with -fakearg to make sure it does not start")
