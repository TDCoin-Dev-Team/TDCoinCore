...
// tdcoin includes.
#include <..\src\script\tdcoinconsensus.h>
...
int main()
{
    std::cout << "tdcoinconsensus version: " << tdcoinconsensus_version() << std::endl;
    ...
    auto op0Result = tdcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, tdcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
